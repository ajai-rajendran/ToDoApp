...
function Header() {
  return(
    <div className="header">
        <svg xmlns="http://www.w3.org/2000/svg" clipRule="evenodd" fillRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2" viewBox="0 0 24 24" width={40} height={40} fill="#fff">
